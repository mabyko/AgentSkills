...
Before release work, search the repository for release guidance rather than assuming a generic process. Look for obvious release docs, changelog conventions, package/version metadata, and GitHub release configuration. Follow repository-specific rules over this reference.
...
Do not update changelog files, create tags, publish GitHub releases, or mark a release as latest unless the user explicitly asked for that action.
