...
Do not squash, rebase-merge, merge, enable auto-merge, or close a PR unless the user or repository policy asks for it. Do not preserve messy `WIP` history; clean it before review when safe using `git-workflow`.
