...
Use this reference only when the user explicitly asks to clean up branches or asks whether a branch can be deleted. Never delete branches as part of a normal commit, push, code review, or release workflow unless the user explicitly requested cleanup.
